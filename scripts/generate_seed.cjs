...
• HomePod mini
AirPods Models
• AirPods Pro 3 to 1st Gen, AirPods Max`
  },
  {
    name: '35W Dual USB-C Port Power Adapter',
    slug: '35w-dual-usb-c-port-power-adapter',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Product Information
...
POWER ADAPTER`
  },
  {
    ...
    slug: 'apple-usb-c-to-lightning-cable-1m',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Product Information
...
USB C`
  ...
  {
    name: 'Samsung Original 65W Trio Port Super Fast Charger',
    slug: 'samsung-original-65w-trio-port-super-fast-charger',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Product information
...
Compatibility
Samsung Galaxy S23, S23 Plus, S23 Ultra, Z Fold4, Z Flip 4, S22 Series, S21 Series, etc.`
  },
  {
    name: '45W Type-C Adaptor with Cable',
    slug: '45w-type-c-adaptor-with-cable',
    category: '11111111-1111-1111-1111-111111111111',
...
Output Current (Max, Fast Charge): PDO : 3 A(9 V, 15 V), 2.25 A(20 V) / PPS : 2.25 A(5.0-20.0 V)`
  },
  {
    name: '25W Travel Adaptor without Cable',
    slug: '25w-travel-adaptor-without-cable',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Specifications
Overview
...
Output Current (Max, Fast Charge): PDO : 2.77 A(9 V) / PPS : 3.0 A(3.3-5.9 V) or 2.25 A(3.3-11.0 V)`
  ...
  {
    name: '45W Type-C Adaptor without Cable',
    slug: '45w-type-c-adaptor-without-cable',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Specifications
Colour: Black
...
Output Current (Max, Fast Charge): PDO : 3 A(9 V, 15 V), 2.25 A(20 V) / PPS : 2.25 A(5.0-20.0 V)`
  ...
  {
    name: 'vivo 80W FlashCharge Charger Adapter',
    slug: 'vivo-80w-flashcharge-charger-adapter',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Product : 80W FlashCharge Charger 
Port : USB 
Color : White 
Input : 100-240V ~ 50/60Hx, 2.5A
Output : 5.0V 2.0A 10.0W or 9.0V 2.0A 18W or 11.0V 6A 66W or 20V 4A Max 80.0W Max`
  },
  {
    name: 'Oneplus Supervooc 45W Adapter',
    slug: 'oneplus-supervooc-45w-adapter',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Product information
Features & Specs
...
Form Factor: Plug`
  },
  {
    ...
    slug: 'apple-type-c-to-type-c-charger-cable-1m',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Product Information
...
USB C`
  },
  {
    ...
    slug: 'samsung-type-c-to-type-c-cable-1m',
    category: '11111111-1111-1111-1111-111111111111',
    description: `Specifications
...
Product Weight: 22.2 g`
  },
  {
    ...
    slug: 'google-pixel-20w-adapter-with-cable',
    category: '11111111-1111-1111-1111-111111111111',
    description: `SPECIFICATIONS
...
Output Wattage - 18 W`
  ...
  {
    name: 'S40 HD Smart Portable Projector',
    slug: 's40-hd-smart-portable-projector',
    category: '22222222-2222-2222-2222-222222222222',
    description: `S40 HD Smart Portable Projector, 3500 Lumens, 180-Degree Projection Angle, Compact Design with Multiple Ports
...
Manufacturer or packer address: India`
  ...
  {
    name: 'Spigen Tempered Glass Guard',
    slug: 'spigen-tempered-glass-guard',
    category: '33333333-3333-3333-3333-333333333333',
    description: `Spigen Tempered Glass Guard for iPhone 11 to iPhone 17 & Samsung All S-Series
...
Screen Surface Description: Glossy`
  ...
  {
    name: 'Spigen Clear Crystal Back Cover Case',
    slug: 'spigen-clear-crystal-back-cover-case',
    category: '33333333-3333-3333-3333-333333333333',
    description: `Spigen Clear Crystal Back Cover Case for iPhone11 to iPhone 17, Clear Transparent, Never Yellow case (Anti Yellow)

Premium quality clear case that won't yellow over time. Provides excellent drop protection while showing off your phone's original color.`
  }
];

let sql = categories;
products.forEach((p, i) => {
  sql += `  (gen_random_uuid(), '${p.name}', '${p.slug}', 0.00, '${p.category}', 10, true, $desc$${p.description}$desc$)`;
...
fs.writeFileSync('c:/Warehouse-website/supabase/seed.sql', sql, 'utf8');
console.log('seed.sql generated with descriptions');
